const FloatMenu = () => {
  return (
    <div className="relative w-11/12 lg:w-10/12 bottom-10 left-1/2 transform -translate-x-1/2 z-20 flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4 p-4 lg:absolute bg-gray-800 bg-opacity-50 rounded-lg">
