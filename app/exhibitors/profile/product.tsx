    ...
    <div className="flex flex-col justify-center px-16 py-20 items-center gap-10">
      ...
      <div>
        <p>
          ...
          Consectetur, officia natus! Cumque aliquam velit quae cum nostrum,
          pariatur, non sit fuga voluptatibus ab nesciunt culpa reiciendis
          consequatur eveniet eos assumenda. Lorem ipsum, dolor sit amet
          consectetur adipisicing elit. Tempore facere mollitia repellendus
          ducimus nostrum ipsum recusandae animi nisi iste delectus? Nihil aut,
          illo similique id quo dolorem ea animi ipsa.
        </p>
      </div>
    </div>
  );
