const FloatMenu = () => {
  return (
    <div className="fixed bottom-10 left-1/2 transform -translate-x-1/2 z-20 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 p-4 bg-gray-800 bg-opacity-50 rounded-lg">
